...
const Terminal = forwardRef<TerminalHandle, TerminalProps>(
  (
    ...
    const commandHistory =
      externalCommandHistory.length > 0
    ...
    const portfolioData = {
      ...
      projects: [
        "🔐 PromptShield - AI Security Sandbox (Featured Project)",
        "   • Enterprise-grade security testing platform for LLM workflows",
        "   • Tech: Go (Gin), React + TypeScript, Docker, Multi-cloud",
        "   • Real-time prompt injection detection with multi-provider AI",
        "   • Live Demo: https://promptshield.vercel.app/",
        "   • Features: Jira simulation, service monitoring, audit logging",
        "",
        ...
        "   • Tech: Angular, Enterprise Architecture, Scalability",
        "",
        ...
        "   • Tech: React, AWS, Real-time Analytics",
        "",
        ...
        "   • Tech: React, Chrome Extensions, Video Streaming",
      ],
      experience: [
    ...
    const executeCommand = useCallback(
      async (cmd: string) => {
        ...
        switch (baseCommand) {
          ...
          case "pwd":
            output = [
              `/home/tijo${currentDirectory === "~" ? "" : currentDirectory}`,
            ];
            break;
          case "whoami":
          ...
          case "projects-demo":
            output = [
              ...
              "",
              "🔐 PromptShield - AI Security Sandbox (FEATURED)",
              "   🌟 Live Demo: https://promptshield.vercel.app/",
              "   🔧 Backend: Go microservices with Gin framework",
              "   ⚡ Frontend: React + TypeScript with Vite",
              "   🚀 Deployment: Docker, Render + Vercel",
              "   💡 Features: Multi-LLM integration, real-time detection",
              "",
              ...
              "   🎯 10k+ concurrent users, 60% render optimization",
              "",
              ...
              "   ☁️ AWS stack with real-time analytics",
              "",
              "🎬 Aviation Chrome Extension",
              "   └─ [PROPRIETARY] Gogo Business Aviation",
              "   🎥 Video streaming for aviation clients",
              "",
              ...
              "💡 Try 'explore projects' for interactive project showcase!",
            ];
            break;
          case "experience":
            output = [
          ...
          case "resume":
            try {
              ...
              output = [
                "❌ Error downloading resume. Please contact tijo1293@gmail.com",
              ];
            }
            break;
          case "git-log":
          ...
          default:
            if (baseCommand === "cd") {
              ...
              const suggestions = availableCommands
                .filter(
                  (cmd) =>
                    cmd.includes(baseCommand) ||
                    baseCommand.includes(cmd.substring(0, 3))
                )
                .slice(0, 3);
        ...
        if (
          cmd.trim() &&
          commandHistory[commandHistory.length - 1] !== cmd.trim()
        ) {

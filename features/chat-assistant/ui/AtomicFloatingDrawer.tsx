...
import AtomicEnhancedChatAgent from "./AtomicEnhancedChatAgent";
import { ChatHeader } from "./organisms/ChatHeader";

interface AtomicFloatingDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  isDragging: boolean;
...
export function AtomicFloatingDrawer({
  isOpen,
  onClose,
  isDragging,
  drawerRef,
